...
import {columns} from "@/components/data-table-columns/archived-delete-patients-columns.tsx";
			...
			<CardHeader className="space-y-2">
				<CardTitle className="flex gap-x-2 items-center">
					<div className="flex items-center gap-x-2">
						...
						<span className="text-lg">Patients supprimés</span>
					</div>
				</CardTitle>
				<CardDescription>Tous les patients qui ont supprimés</CardDescription>
			</CardHeader>
			<CardContent>
				<DataTable columns={columnsDef} data={patients}/>
			</CardContent>
		</Card>
	)
}