...
export default function UploadImageDialog() {
	...
	const selectImage = (event: React.ChangeEvent<HTMLInputElement>) => {
		...
		setcurrentImages([...selectedFiles]);
		...
		<DialogContent>
			...
			<div className="flex items-center justify-center w-full mt-5">
				...
				{previewImages.length !== 0 ?
					...
					:
					<label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-64 border-2  border-dashed rounded-lg cursor-pointer bg-muted/80 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-muted/40 dark:bg-muted/30 dark:hover:bg-muted/40">
