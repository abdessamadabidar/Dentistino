...
import {columns} from "@/components/data-table-columns/archived-delete-appointment-columns.tsx";
...
export default function ArchivedAppointments() {
	...
	return (
		<Card>
			...
			<CardContent>
				<DataTable columns={columnsDef} data={appointments} />
			</CardContent>
			<CardFooter className="text-sm text-foreground/60 text-center block">Ces rendez-vous sont archivés</CardFooter>
		</Card>
	)
}