					...
					<div className="space-y-2">
						...
						<div className="space-y-1">
							...
							<div className="relative">
								{
									passwordIsVisible ? (
										<Button variant="outline" className="border-0 bg-transparent hover:bg-transparent absolute right-0 focus-visible:ring-0" onClick={passwordVisibiltyToggle}>
