						...
						<div className="space-y-2">
							<CardTitle className="flex flex-nowrap items-center gap-x-2">
								<div className="flex items-center gap-x-2">
									...
									<span className="text-lg">Rendez-vous</span>
								</div>
							</CardTitle>
							<CardDescription>Tous les patients prévus pour la consultation</CardDescription>
						</div>
			...
			<TabsContent value="today" className="space-y-4">
				<Card>
					<CardHeader className="space-y-2">
						...
						<CardDescription>Tous les patients programmés pour une consultation aujourd'hui</CardDescription>
					</CardHeader>
					<CardContent className="px-14">
						<DataTable columns={columns} data={appointments}/>
					</CardContent>
