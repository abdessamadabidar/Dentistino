						...
						<Card>
							<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
								...
								<span className="p-3 text-white bg-gradient-to-l from-green-400 to-emerald-400 rounded-lg">
									<svg className="h-4 w-4 inherit" viewBox="0 0 24 24" strokeWidth="1.5"
										...
										<path d="M5 2L12 2L19 2" stroke="currentColor" strokeWidth="1.5"
											  strokeLinecap="round" strokeLinejoin="round"></path>
										<path d="M5 22H12L19 22" stroke="currentColor" strokeWidth="1.5"
											  strokeLinecap="round" strokeLinejoin="round"></path>
									</svg>
								</span>
							</CardHeader>
							...
							<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
								...
								<span className="p-3 text-white bg-gradient-to-l from-red-400 to-rose-400 rounded-lg">
									<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
										 strokeWidth={1.5} stroke="currentColor" className="h-4 w-4 inherit">
