		...
		<>
			<Tabs defaultValue="overview" className="space-y-4">
				<TabsList className="rounded-lg">
					<TabsTrigger className="rounded-md" value="overview">Aperçu</TabsTrigger>
					<TabsTrigger className="rounded-md" value="analytics" >
						Statistiques
					</TabsTrigger>
				</TabsList>
					...
					<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
						<Card>
							<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
								...
								<span className="p-3 text-white bg-gradient-to-l from-indigo-400 to-indigo-500 rounded-lg">
									<svg
						...
						<Card>
							<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
								...
								<span className="p-3 text-white bg-gradient-to-l from-red-400 to-orange-300 rounded-lg">
									<svg
										xmlns="http://www.w3.org/2000/svg"
										viewBox="0 0 24 24"
										fill="none"
						...
						<Card>
							<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
								...
								<span className="p-3 text-white bg-gradient-to-l from-green-400 to-emerald-400 rounded-lg">
									<svg className="h-4 w-4 inherit" viewBox="0 0 24 24" strokeWidth="1.5" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor">
										<path
						...
						<Card>
							<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
								...
								<span className="p-3 text-white bg-gradient-to-l from-red-400 to-rose-400 rounded-lg">
									<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-4 w-4 inherit">
							...
							<CardHeader>
								<CardTitle className="flex flex-nowrap items-center justify-between gap-x-2">
									<div className="flex flex-nowrap items-center gap-x-2">
										...
										<span className="text-xl">Salle d'attente</span>
									</div>
							...
							<CardHeader>
								<CardTitle className="flex flex-nowrap items-center justify-between gap-x-2">
									<div className="flex flex-nowrap items-center gap-x-2">
										...
										<span className="text-xl">Nouveaux patients</span>
									</div>
									<a className="text-sm text-end flex flex-nowrap items-center gap-x-2 group" href={"#"}>
										voir tous
										<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 22" strokeWidth={1.5} stroke="currentColor" className="size-4 group-hover:translate-x-1 transition-all duration-500">
